...
> = {
  [POLKADOT_CHAIN_ID.shibuya]: {
    ...
    addresses: {
      controller: 'YazYPrTGHY4TGn9nPJ9fA18Fgd4fmJ4u9EsZj83Uh8B27tm',
      lens: 'XznwwZrmad775xcazMmtiXRUKDUSCqXFizkGHqLx3LdytHT',
      faucet: 'ah1mCdAUx1LrQ9gapkZwoNQMrJZ2ZjCiZE8ss2hU9ao9W2t',
    },
    baseAsset: {
      symbol: 'ASTR',
      wrapperAddress: '',
