...
> = {
  [POLKADOT_CHAIN_ID.shibuya]: {
    ...
    addresses: {
      controller: 'aqQayhaH9qDj28QGwkNoF4rF9GDT1BPadjeQrZWUx75BM2c',
      lens: 'bSPtCP3RMNCtE7svFmrjARKzHFW1XCM9jP8cUWZBzR2pLg6',
      faucet: 'WKaE174yJp7FW7deg8Cyk3BbPpKyVGZu7xy8JqUNiCVU9jF',
    },
    baseAsset: {
      symbol: 'ASTR',
      wrapperAddress: '',
