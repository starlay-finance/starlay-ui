...
import { ContractAbi } from '../contract-info/manager';
import QueryMethods from '../query/manager';
import BuildExtrinsicMethods from '../build-extrinsic/manager';
import TxSignAndSendMethods from '../tx-sign-and-send/manager';
import MixedMethods from '../mixed-methods/manager';
import EventsClass from '../events/manager';
