...
export default class Methods {
	...
	*/
	"getBorrowRate" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "interestRateModel::getBorrowRate", [cash, borrows, reserves], __options, (result) => { return handleReturnType(result, getTypeDescription(8, 'default_interest_rate_model')); });
	}
	...
	*/
	"getSupplyRate" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "interestRateModel::getSupplyRate", [cash, borrows, reserves, reserveFactorMantissa], __options, (result) => { return handleReturnType(result, getTypeDescription(8, 'default_interest_rate_model')); });
	}
