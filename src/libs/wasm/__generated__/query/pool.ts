...
export default class Methods {
	...
	*/
	"exchangeRateCurrent" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::exchangeRateCurrent", [], __options , (result) => { return handleReturnType(result, getTypeDescription(12, 'pool')); });
	}
	...
	*/
	"balanceOfUnderlyingCurrent" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::balanceOfUnderlyingCurrent", [account], __options , (result) => { return handleReturnType(result, getTypeDescription(17, 'pool')); });
	}
	...
	*/
	"borrow" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::borrow", [borrowAmount], __options , (result) => { return handleReturnType(result, getTypeDescription(19, 'pool')); });
	}
	...
	*/
	"repayBorrow" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::repayBorrow", [repayAmount], __options , (result) => { return handleReturnType(result, getTypeDescription(19, 'pool')); });
	}
	...
	*/
	"mint" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::mint", [mintAmount], __options , (result) => { return handleReturnType(result, getTypeDescription(19, 'pool')); });
	}
	...
	*/
	"borrowBalanceCurrent" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::borrowBalanceCurrent", [account], __options , (result) => { return handleReturnType(result, getTypeDescription(17, 'pool')); });
	}
	...
	*/
	"redeemUnderlying" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::redeemUnderlying", [redeemAmount], __options , (result) => { return handleReturnType(result, getTypeDescription(19, 'pool')); });
	}
	...
	*/
	"liquidateBorrow" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::liquidateBorrow", [borrower, repayAmount, collateral], __options , (result) => { return handleReturnType(result, getTypeDescription(19, 'pool')); });
	}
	...
	*/
	"reduceReserves" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::reduceReserves", [amount], __options , (result) => { return handleReturnType(result, getTypeDescription(19, 'pool')); });
	}
	...
	*/
	"repayBorrowBehalf" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::repayBorrowBehalf", [borrower, repayAmount], __options , (result) => { return handleReturnType(result, getTypeDescription(19, 'pool')); });
	}
	...
	*/
	"seize" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::seize", [liquidator, borrower, seizeTokens], __options , (result) => { return handleReturnType(result, getTypeDescription(19, 'pool')); });
	}
	...
	*/
	"redeem" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "pool::redeem", [redeemTokens], __options , (result) => { return handleReturnType(result, getTypeDescription(19, 'pool')); });
	}
	...
	*/
	"transferFrom" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::transferFrom", [from, to, value, data], __options , (result) => { return handleReturnType(result, getTypeDescription(24, 'pool')); });
	}
	...
	*/
	"approve" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::approve", [spender, value], __options , (result) => { return handleReturnType(result, getTypeDescription(24, 'pool')); });
	}
	...
	*/
	"decreaseAllowance" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::decreaseAllowance", [spender, deltaValue], __options , (result) => { return handleReturnType(result, getTypeDescription(24, 'pool')); });
	}
	...
	*/
	"transfer" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::transfer", [to, value, data], __options , (result) => { return handleReturnType(result, getTypeDescription(24, 'pool')); });
	}
	...
	*/
	"increaseAllowance" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "psp22::increaseAllowance", [spender, deltaValue], __options , (result) => { return handleReturnType(result, getTypeDescription(24, 'pool')); });
	}
