...
export type GetCurrentDataQuery = {
  __typename?: 'Query'
  projectStatistic?: {
    __typename?: 'ProjectStatistic'
    numOfBidders: string
...
export function getSdk(
  ...
  return {
    GetBid(
      variables: GetBidQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<GetBidQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetBidQuery>(GetBidDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetBid',
    ...
    GetCurrentData(
      variables: GetCurrentDataQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<GetCurrentDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCurrentDataQuery>(
            GetCurrentDataDocument,
            variables,
