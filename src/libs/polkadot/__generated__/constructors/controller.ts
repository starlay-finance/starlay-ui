...
import { ContractFile } from '../contract-info/controller';
...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.AccountId } manager,
	*/
   	async "new" (
		manager: ArgumentTypes.AccountId,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, manager);
			let response;
