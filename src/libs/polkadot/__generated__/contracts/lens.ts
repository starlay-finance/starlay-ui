...
import { ContractAbi } from '../contract-info/lens';
import QueryMethods from '../query/lens';
import BuildExtrinsicMethods from '../build-extrinsic/lens';
import TxSignAndSendMethods from '../tx-sign-and-send/lens';
import MixedMethods from '../mixed-methods/lens';
import EventsClass from '../events/lens';
