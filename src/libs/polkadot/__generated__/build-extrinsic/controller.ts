...
export default class Methods {
	...
	*/
	"transferAllowed" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "controller::transferAllowed", [pool, src, dst, transferTokens, poolAttribure], __options);
	}
