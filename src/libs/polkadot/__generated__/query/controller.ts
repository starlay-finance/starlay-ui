...
export default class Methods {
	...
	*/
	"transferGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::transferGuardianPaused", [], __options , (result) => { return handleReturnType(result, getTypeDescription(16, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"oracle" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::oracle", [], __options , (result) => { return handleReturnType(result, getTypeDescription(17, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"isListed" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::isListed", [pool], __options , (result) => { return handleReturnType(result, getTypeDescription(16, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	* @param { (string | number | BN) } redeemTokens,
	* @param { (string | number | BN) } borrowAmount,
	* @returns { Result<[ReturnTypes.U256, ReturnTypes.U256], ReturnTypes.LangError> }
	*/
	"getHypotheticalAccountLiquidity" (
		...
		borrowAmount: (string | number | BN),
		__options ? : GasLimit,
	): Promise< QueryReturnType< Result<[ReturnTypes.U256, ReturnTypes.U256], ReturnTypes.LangError> > >{
	...
	*/
	"seizeGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::seizeGuardianPaused", [], __options , (result) => { return handleReturnType(result, getTypeDescription(16, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"markets" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::markets", [], __options , (result) => { return handleReturnType(result, getTypeDescription(20, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"closeFactorMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::closeFactorMantissa", [], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"borrowGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::borrowGuardianPaused", [pool], __options , (result) => { return handleReturnType(result, getTypeDescription(22, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"liquidationIncentiveMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::liquidationIncentiveMantissa", [], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"borrowCap" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::borrowCap", [pool], __options , (result) => { return handleReturnType(result, getTypeDescription(24, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"manager" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::manager", [], __options , (result) => { return handleReturnType(result, getTypeDescription(17, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"liquidateCalculateSeizeTokens" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::liquidateCalculateSeizeTokens", [poolBorrowed, poolCollateral, exchangeRateMantissa, repayAmount], __options , (result) => { return handleReturnType(result, getTypeDescription(26, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"mintGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::mintGuardianPaused", [pool], __options , (result) => { return handleReturnType(result, getTypeDescription(22, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"accountAssets" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::accountAssets", [account], __options , (result) => { return handleReturnType(result, getTypeDescription(20, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"collateralFactorMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::collateralFactorMantissa", [pool], __options , (result) => { return handleReturnType(result, getTypeDescription(28, DATA_TYPE_DESCRIPTIONS)); });
	}
