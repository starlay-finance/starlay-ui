...
export default class Methods {
	...
	*/
	"supportMarket" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::supportMarket", [pool], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setBorrowGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setBorrowGuardianPaused", [pool, paused], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setCloseFactorMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setCloseFactorMantissa", [newCloseFactorMantissa], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setCollateralFactorMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setCollateralFactorMantissa", [pool, newCollateralFactorMantissa], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setLiquidationIncentiveMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setLiquidationIncentiveMantissa", [newLiquidationIncentiveMantissa], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setTransferGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setTransferGuardianPaused", [paused], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setMintGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setMintGuardianPaused", [pool, paused], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setPriceOracle" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setPriceOracle", [newOracle], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setSeizeGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setSeizeGuardianPaused", [paused], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setBorrowCap" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setBorrowCap", [pool, newCap], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"supportMarketWithCollateralFactorMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::supportMarketWithCollateralFactorMantissa", [pool, collateralFactorMantissa], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
