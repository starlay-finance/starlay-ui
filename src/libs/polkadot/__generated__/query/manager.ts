...
export default class Methods {
  ...
  > {
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(7, 'manager'))
      },
    )
  }
  ...
  grantRole(
    ...
    QueryReturnType<
      Result<
        Result<null, ReturnTypes.AccessControlError>,
  ...
  > {
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(18, 'manager'))
      },
    )
  }
