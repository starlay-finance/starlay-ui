...
export default class Methods {
   ...
   * @returns { void }
   */
  exchangeRateCurrent(__options: GasLimit) {
   ...
   * @returns { void }
   */
  borrow(borrowAmount: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @returns { void }
   */
  repayBorrow(repayAmount: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @returns { void }
   */
  mint(mintAmount: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @returns { void }
   */
  borrowBalanceCurrent(account: ArgumentTypes.AccountId, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @returns { void }
   */
  redeemUnderlying(redeemAmount: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @returns { void }
   */
  reduceReserves(amount: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @returns { void }
   */
  redeem(redeemTokens: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
