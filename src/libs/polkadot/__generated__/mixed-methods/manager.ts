...
export default class Methods {
   ...
   * @returns { void }
   */
  setPriceOracle(newOracle: ArgumentTypes.AccountId, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
      'manager::setPriceOracle',
      (events: EventRecord) => {
   ...
   * @returns { void }
   */
  setController(address: ArgumentTypes.AccountId, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @returns { void }
   */
  supportMarket(pool: ArgumentTypes.AccountId, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
      'manager::supportMarket',
      (events: EventRecord) => {
        return decodeEvents(events, this.__nativeContract, 'manager')
      },
      [pool],
  ...
  setBorrowGuardianPaused(
    ...
    return txSignAndSend(
      ...
      this.__nativeContract,
      this.__keyringPair,
      'manager::setBorrowGuardianPaused',
      (events: EventRecord) => {
        return decodeEvents(events, this.__nativeContract, 'manager')
      },
      [pool, paused],
  ...
  setLiquidationIncentiveMantissa(
    ...
    return txSignAndSend(
      ...
      this.__nativeContract,
      this.__keyringPair,
      'manager::setLiquidationIncentiveMantissa',
      (events: EventRecord) => {
        return decodeEvents(events, this.__nativeContract, 'manager')
      },
  ...
  setCloseFactorMantissa(
    ...
    return txSignAndSend(
      ...
      this.__nativeContract,
      this.__keyringPair,
      'manager::setCloseFactorMantissa',
      (events: EventRecord) => {
        return decodeEvents(events, this.__nativeContract, 'manager')
      },
  ...
  > {
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(17, 'manager'))
      },
    )
  }
  ...
  getRoleAdmin(
    ...
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(20, 'manager'))
      },
    )
  }
  ...
  hasRole(
    ...
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(21, 'manager'))
      },
    )
  }
